...
----------------------------
revision 1.23
date: 2008/08/07 18:41:58;  author: nwiger;  state: Exp;  lines: +62 -20
- added patch from Laurent Dami that added +/- support and subquery fixes
- added patch from Robbie Bow for "quote_char" to fix MQ SQL Server
- added patch from Norbert Buchmuller to enable the use of "<>" to mean IS NOT NULL
----------------------------
revision 1.20
